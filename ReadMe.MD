...
- Safe memory reading with `IsBadReadPtr` validation
...
5. Press `F11` to open Settings and configure overlays, buffs, and raid tracking
6. All overlays are draggable — position them wherever you like
